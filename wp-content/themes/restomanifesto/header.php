...
<!--[if (gt IE 9)|!(IE)]><!--> <body <?php body_class('ie6'); ?>> <!--<![endif]-->
  ...
  <div id="container">
    <header role="banner">
      <h1><a class="ir" href="<?php echo get_option('home'); ?>/"><?php bloginfo('name'); ?></a></h1>
      <p id="blog-description"><?php bloginfo('description'); ?></p>
      <nav id="review-selector"></nav>
      <nav id="main-nav" class="clearfix"><?php wp_nav_menu(array('theme_location' => 'main-nav', 'container' => '' )); ?><?php //wp_nav_menu(array('theme_location' => 'contact-menu', 'container' => '' ));?></nav>
	<?php get_search_form(); ?>
    </header>
